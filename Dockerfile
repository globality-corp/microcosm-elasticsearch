...
FROM python:3.7-slim-stretch as deps
...
ENV NAME microcosm_elasticsearch
...
LABEL microcosm.elasticsearch=true

ARG BUILD_NUM
ARG SHA1
ENV MICROCOSM_ELASTICSEARCH__BUILD_INFO_CONVENTION__BUILD_NUM ${BUILD_NUM}
ENV MICROCOSM_ELASTICSEARCH__BUILD_INFO_CONVENTION__SHA1 ${SHA1}
COPY $NAME /src/$NAME/
